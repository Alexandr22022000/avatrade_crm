module.exports = {
    SERVICES_GET: 'SELECT id, name, is_product, price, consumables, status FROM services WHERE (LOWER(name) like LOWER($1) OR $1 IS NULL) AND (status = $2 OR $2 IS NULL) AND (is_product = $3 OR $3 IS NULL)',
