        ...
        if (this.props.currentUser) {
            ...
            editor = (
                <div>
                    ...
                    <StuffInput
                        title={"Ранг:"}
                        value={this.listProcessorVales([this.props.currentUser.rank], this.props.ranks)[0]}
                        onChange={(v) => this.props.updateUserData(this.listProcessorWriter([v], this.props.ranks)[0], 'rank')}
                    ...
                    <MultiInput
                        title={"Должность:"}
                        values={this.listProcessorVales(this.props.currentUser.permissions, permissions)}
                        onChange={(v) => this.props.updateUserData(this.listProcessorWriter(v, permissions), 'permissions')}
